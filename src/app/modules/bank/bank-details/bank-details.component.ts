...
export class BankDetailsComponent implements OnInit {
  ...
  @ViewChild('date')dateElement: ElementRef<HTMLInputElement>;

  @ViewChild('toCodeElement')toCodeElement: ElementRef<HTMLInputElement>;
  @ViewChild('tofirmName') tofirmName: ElementRef<HTMLInputElement>;
  ...
  @ViewChild('dtlsForm') set bankDtlsFormElement(element) {
    if (element) {
